...
let rec goal    (d : int)  (s0 : int)  (lo : int)  (hi : int) : (int tree) = 
 	 if (  ( lt_eq_one  d )  ) 
 then 
 	  ( Node (  ( increment  d1 ) ,  ( goal  d1  ( increment  d )   ( increment  s0 )  hi ) ,  ( goal  d1  ( increment  d1 )  a hi )  ) ) 
 else 
 	if (  ( bool_gen  dummy )  ) 
 then 
...
let rec goal    (d : int)  (s0 : int)  (lo : int)  (hi : int) : (int tree) = 
 	 if (  ( lt_eq_one  d )  ) 
 then 
 	  ( Node (  ( increment  a ) ,  ( goal  d1 s0 hi hi ) ,  ( goal  d1 s0 hi hi )  ) ) 
 else 
 	if (  ( bool_gen  dummy )  ) 
 then 
 	  ( goal   ( increment  s )   ( increment  lo )   ( increment  d )   ( increment  s )  )  
...
let rec goal    (d : int)  (s0 : int)  (lo : int)  (hi : int) : (int tree) = 
 	 if (  ( lt_eq_one  d )  ) 
 then 
 	  ( Node ( lo,  ( goal  d1 s0 hi hi ) ,  ( goal  d1 d1  ( increment  b )   ( increment  d )  )  ) ) 
 else 
 	if (  ( bool_gen  dummy )  ) 
 then 
 	  ( goal   ( increment  s )   ( increment  lo )   ( increment  d )   ( increment  s )  )  
...
let rec goal    (d : int)  (s0 : int)  (lo : int)  (hi : int) : (int tree) = 
 ...
 then 
 	 ...
 	 ( goal   ( increment  lo )   ( increment  hi )  n  ( increment  d )  ) 
 (* Program *) 
let rec goal    (d : int)  (s0 : int)  (lo : int)  (hi : int) : (int tree) = 
 	 if (  ( lt_eq_one  s0 )  ) 
 then 
...
let rec goal    (d : int)  (s0 : int)  (lo : int)  (hi : int) : (int tree) = 
 	 if (  ( lt_eq_one  hi )  ) 
 then 
 	  ( Node (  ( increment  lo ) ,  ( goal   ( increment  lo )  d  ( increment  d )  hi ) ,  ( goal   ( increment  s0 )   ( increment  d )  n  ( increment  lo )  )  ) ) 
 else 
