...
let rec goal    (size : int)  (x0 : int) : (int list) = 
 ...
 then 
 	 ...
 	 ( subs   ( gt_eq_int_gen  x0 )  )  ::  ( goal   ( subs   ( gt_eq_int_gen  x0 )  )  x0 ) 
 (* Program *) 
let rec goal    (size : int)  (x0 : int) : (int list) = 
 	 if (  ( sizecheck  x0 )  ) 
 then 
...
let rec goal    (size : int)  (x0 : int) : (int list) = 
 	 if (  ( sizecheck  x0 )  ) 
 then 
 	  ( subs   ( gt_eq_int_gen  x0 )  )  ::  ( goal   ( subs  size )   ( gt_eq_int_gen  x0 )  )  
 else 
...
let rec goal    (size : int)  (x0 : int) : (int list) = 
 	 if (  ( sizecheck  x0 )  ) 
 then 
 	  ( subs  size )  ::  ( goal   ( gt_eq_int_gen  x0 )  x0 )  
 else 
 	 ( subs   ( gt_eq_int_gen  x0 )  )  :: []
 (* Program *) 
let rec goal    (size : int)  (x0 : int) : (int list) = 
...
let rec goal    (size : int)  (x0 : int) : (int list) = 
 ...
 then 
 	 ...
 	 ( subs  size )  ::  ( goal  size1  ( gt_eq_int_gen  x0 )  ) 
 (* Program *) 
let rec goal    (size : int)  (x0 : int) : (int list) = 
 	 if (  ( sizecheck  x0 )  ) 
 then 
...
let rec goal    (size : int)  (x0 : int) : (int list) = 
 ...
 then 
 	 ...
 	 ( gt_eq_int_gen  x0 )  ::  ( goal  size1  ( gt_eq_int_gen  x0 )  ) 
 (* Program *) 
let rec goal    (size : int)  (x0 : int) : (int list) = 
 	 if (  ( sizecheck  x0 )  ) 
 then 
