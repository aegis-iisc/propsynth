...
let rec goal    (size : int)  (x0 : int) : (int ulist) = 
 ...
 then 
 	 ...
 	 ( subs  x0 )  +::  ( goal   ( subs  x0 )   ( subs  size )  ) 
 (* Program *) 
let rec goal    (size : int)  (x0 : int) : (int ulist) = 
 	 if (  ( sizecheck  size )  ) 
 then 
...
let rec goal    (size : int)  (x0 : int) : (int ulist) = 
 ...
 then 
 	 ...
 	 ( subs  size )  +::  ( goal  size1  ( subs  size )  ) 
 (* Program *) 
let rec goal    (size : int)  (x0 : int) : (int ulist) = 
 	 if (  ( sizecheck  x0 )  ) 
 then 
...
let rec goal    (size : int)  (x0 : int) : (int ulist) = 
 ...
 then 
 	 ...
 	 ( subs  size1 )  +::  ( goal   ( subs  size )   ( subs  x0 )  ) 
 (* Program *) 
let rec goal    (size : int)  (x0 : int) : (int ulist) = 
 	 if (  ( sizecheck  x0 )  ) 
 then 
...
let rec goal    (size : int)  (x0 : int) : (int ulist) = 
 ...
 then 
 	 ...
 	 ( subs  size1 )  +::  ( goal   ( subs  size1 )   ( subs  size )  ) 
 (* Program *) 
let rec goal    (size : int)  (x0 : int) : (int ulist) = 
 	 if (  ( sizecheck  x0 )  ) 
 then 
...
let rec goal    (size : int)  (x0 : int) : (int ulist) = 
 ...
 then 
 	 ...
 	 ( subs  size )  +::  ( goal   ( subs  size )   ( subs  size1 )  ) 
 (* Program *) 
let rec goal    (size : int)  (x0 : int) : (int ulist) = 
 	 if (  ( sizecheck  x0 )  ) 
 then 
...
let rec goal    (size : int)  (x0 : int) : (int ulist) = 
 ...
 then 
 	 ...
 	 ( subs  x0 )  +::  ( goal   ( subs  size1 )   ( subs  size1 )  ) 
 (* Program *) 
let rec goal    (size : int)  (x0 : int) : (int ulist) = 
 	 if (  ( sizecheck  x0 )  ) 
 then 
