...
dff : ( x_1 : { v : Graph | true }) -> ( x_2 : { v : Forest | true }) State {\(h : heap). true } v : {v : Vertex | true } {\(h : heap), (v : Vertex), (h' : heap). [h' = h]};
...
unions : ( x_1 : { v : [Seta] | true }) -> State {\(h : heap). true } v : {v : Seta | true } {\(h : heap), (v : Seta), (h' : heap). [h' = h]};
difference : ( x_1 : { v : Seta | true }) -> ( x_2 : { v : Seta | true }) -> State {\(h : heap). true } v : {v : Seta | true } {\(h : heap), (v : Seta), (h' : heap). [h' = h]};
   ( x_1 : { v : \\ | true })   : ( x_2 : { v : Seta | true }) -> ( x_3 : { v : Seta | true }) -> State {\(h : heap). true } v : {v : Seta | true } {\(h : heap), (v : Seta), (h' : heap). [h' = h]};
...
spanAntitone :   ( x_1 : { v : a | true }) -> ( x_2 : { v : Bool | true })   -> ( x_3 : { v : Seta | true }) ->   ( x_4 : { v : Seta, | true }) ( x_5 : { v : Seta | true }) State {\(h : heap). true } v : {v : ) | true } {\(h : heap), (v : )), (h' : heap). [h' = h]};
partition :   ( x_1 : { v : a | true }) -> ( x_2 : { v : Bool | true })   -> ( x_3 : { v : Seta | true }) ->   ( x_4 : { v : Seta, | true }) ( x_5 : { v : Seta | true }) State {\(h : heap). true } v : {v : ) | true } {\(h : heap), (v : )), (h' : heap). [h' = h]};
split : ( x_1 : { v : a | true }) -> ( x_2 : { v : Seta | true }) ->   ( x_3 : { v : Seta, | true }) ( x_4 : { v : Seta | true }) State {\(h : heap). true } v : {v : ) | true } {\(h : heap), (v : )), (h' : heap). [h' = h]};
splitMember : ( x_1 : { v : a | true }) -> ( x_2 : { v : Seta | true }) ->   ( x_3 : { v : Seta, | true }) ( x_4 : { v : Bool, | true }) ( x_5 : { v : Seta | true }) State {\(h : heap). true } v : {v : ) | true } {\(h : heap), (v : )), (h' : heap). [h' = h]};
...
splitAt : ( x_1 : { v : Int | true }) -> ( x_2 : { v : Seta | true }) ->   ( x_3 : { v : Seta, | true }) ( x_4 : { v : Seta | true }) State {\(h : heap). true } v : {v : ) | true } {\(h : heap), (v : )), (h' : heap). [h' = h]};
