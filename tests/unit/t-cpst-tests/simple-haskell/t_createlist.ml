...
let specfile = "tests/unit/t-cpst-tests/simple-haskell/t_createlist.spec"
(* 
 * I = { ();}
 * d = []
 * A(q0) = {return 1}
        ...
        in    
                      ...
                      (*  Trans.Lambda (T_var "x", getType "x",
                             Trans.Lambda( T_var "exp", getType "exp",) *)
                                Trans.Lambda (T_var "of", getType "of", Trans.ST transition_system)

let () = 
   Morpheus.verifyCPST gamma t_createlist (getType "annot") false 
