(*
* coontent = \len. digit+ [len content = len]
*
...
open SB  
open Trans
let specfile = "tests/unit/t-cpst-tests/png/t_content.spec"  
...
let () = 
   Morpheus.verifyCPST gamma t_content (getType "annot") true
