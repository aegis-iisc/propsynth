...
let specfile = "tests/unit/t-cpst-tests/xprotein/t_header_action.spec"
(* 
 * I = { ();}
 * d = []
 * A(q0) = {return 1}
        ...
        in    
                       ...
                       (* Trans.Lambda (T_var "node", getType "node",
                             Trans.Lambda( T_var "indent", getType "indent", 
                                Trans.Lambda (T_var "children", getType "children", *)
                Trans.Lambda (T_var "uid", getType "uid", Trans.ST transition_system)
