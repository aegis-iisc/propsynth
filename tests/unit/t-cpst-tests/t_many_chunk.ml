...
let specfile = "tests/unit/t-cpst-tests/t_many_chunk.spec"  
...
(*define transducer*)     
let t_fold=                    
        let trans_t = T_chunk.t_chunk in 
        ...
        Trans.Fold (trans_t, f_typed, g, acc_type, inv, pre_post)  
let () = 
   Morpheus.verifyCPST gamma t_fold (getType "annotfold")     
