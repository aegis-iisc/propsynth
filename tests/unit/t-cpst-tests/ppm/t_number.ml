...
open SB  
open Trans
let specfile = "tests/unit/t-cpst-tests/t_number.spec"  
...
let step2 = T_lam ("x", (T_var "x"), getType "step1") 
...
let t_number = 
        ...
        let _d1 = Trans.Del {name = "_d1";src = "q0"; tgt = "qf"; guard=getFormula "guardtrue"; step=(step1); inv = True} in 
...
let () = 
   Morpheus.verifyCPST gamma t_number (getType "annot")
